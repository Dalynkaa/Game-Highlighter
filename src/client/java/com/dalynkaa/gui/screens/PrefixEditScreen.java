...
public class PrefixEditScreen extends BaseOwoScreen<FlowLayout> {
    ...
    protected void build(FlowLayout rootComponent) {
        ...
        ParentComponent color_picker_container_player = collorPicker(prefix_player_color,prefix != null ? prefix.getColor() : "#a29bfe");
        ParentComponent color_picker_container_prefix = collorPicker(prefix_prefix_color,prefix != null ? prefix.getPrefix_color() : "#6c5ce7");
        ...
        ParentComponent color_container = Containers.verticalFlow(Sizing.content(), Sizing.content())
                ...
                .child(color_picker_container_player.margins(Insets.of(0,5,0,0)));
        ParentComponent prefix_color_container = Containers.verticalFlow(Sizing.content(), Sizing.content())
                ...
                .child(color_picker_container_prefix.margins(Insets.of(0,5,0,0)));
